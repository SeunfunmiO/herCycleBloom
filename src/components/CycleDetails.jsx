        ...
        <div>
                ...
                <div className="mt-5">
                    ...
                    <div className='flex items-center gap-3 mt-8 justify-between'>
                        <div className='flex gap-3 items-center'>
                            <p className="text-gray-500 font-semibold">Top Symptoms Logged : </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    <div className="border-2 border-gray-100 rounded-xl h-20 flex items-center justify-between px-3">
                        <div className="flex flex-col">
                            <h1 className="font-medium">July 3 <span className='text-gray-500'> (Day 1)</span></h1>
                            <div className='flex items-center gap-2'>
                    ...
                    <div className="border-2 border-gray-100 rounded-xl h-20 flex items-center justify-between px-3">
                        <div className="flex flex-col">
                            <h1 className="font-medium">July 4 <span className='text-gray-500'> (Day 2)</span></h1>
                            <div className='flex items-center gap-2'>
                    ...
                    <div className="border-2 border-gray-100 rounded-xl h-20 flex items-center justify-between px-3">
                        <div className="flex flex-col">
                            <h1 className="font-medium">July 5 <span className='text-gray-500'> (Day 3)</span></h1>
                            <div className='flex items-center gap-2'>
                                <p className="font-semibold">Medium</p>
                                <img src="./medium-flow.svg" alt="droplet" />
                            </div>
            ...
            <div className='px-4 flex flex-col gap-5 mt-5'>
                ...
                <div className='flex items-center gap-1 font-medium'>
                    <p className="text-gray-500">Average Cycle Length : </p>
                    <span>29 days</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    <div className='flex items-center gap-3'>
                        ...
                        <p className='font-medium text-lime-600 text-sm'>Your flow tends to be heaviest on Day 2.</p>
                    </div>

                    <div className='flex items-center gap-3'>
                        <img src="./Bulb.svg" alt="icon" />
                        <p className='font-medium text-lime-600 text-sm'>Headaches often occur 2 days before your period.</p>
                    </div>

                    <div className='flex items-center gap-3'>
                        <img src="./Bulb.svg" alt="icon" />
                        <p className='font-medium text-lime-600 text-sm'>You often feel more energetic on during your follicularphase.</p>
                    </div>
                </div>
            </div>
        </div>
