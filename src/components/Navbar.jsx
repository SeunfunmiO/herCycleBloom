...
const Navbar = () => {
    ...
    return (
        <div className='bg-white fixed bottom-0 flex items-center w-full justify-between md:gap-10 p-5 border-t border-gray-200'>

            <button
                className={`flex flex-col items-center border-0 outline-0`}>
                <img className='w-3 h-3 md:w-5 md:h-5' src="./Vector - 0.svg" alt="Home" />
                <p className="text-xs md:text-base font-bold">Overview</p>
            </button>
